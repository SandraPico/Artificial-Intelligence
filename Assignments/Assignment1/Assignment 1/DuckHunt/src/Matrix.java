...
public class Matrix {
	...
	//Properties
	 ...
	 //To build the matrix we need how many rows and how many columns...
	...
	//Add the data in the matrix.
	//In order to add data in our matrix we will use a List of double.
	...
	/********************************************
	 * 
	 * Getters and setters of Matrix's properties
	 * 
	 ********************************************/
	public int getRows() {
		return rows;
